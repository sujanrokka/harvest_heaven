...
<body class="w-full h-[100vh] flex justify-center items-center flex-col formbg" >
    ...
    <h1 class="text-grey font-bold text-2xl bg-green-500 p-4 m-2 w-1/2 text-center text-white rounded-xl">Buyer Login Page </h1>
    <form method="POST" action="buyerLogin" class="p-4 m-4  bg-[#f8f246] flex flex-col w-1/2 justify-center items-center rounded-xl">
        @csrf
    ...
    <button class="m-2 p-2 w-[40vw] rounded-xl bg-green-500" type="submit">Login</button>
