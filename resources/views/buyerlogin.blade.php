...
<body class="w-full h-[100vh] flex justify-center items-center flex-col formbg" >
    ...
    <form method="POST" action="buyerLogin" class="p-4 m-4  bg-[#d678358f] flex flex-col w-1/2 justify-center items-center rounded-xl">
        @csrf
    ...
    <button class="m-2 p-2 w-[40vw] rounded-xl bg-green-300" type="submit">Login</button>
