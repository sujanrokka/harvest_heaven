...
<head>
    ...
    <title>Farmer</title>
    <link rel="stylesheet" href="{{ url('/') }}/landing/styles.css" />
...
<body>
    ...
    <nav class="fixed flex justify-between py-6 w-full lg:px-48 md:px-12 px-4 content-center bg-secondary z-10">
        <div class="flex items-center">
            <img src='{{ url('/') }}/landing/assets/Logo_black.svg' alt="Logo" class="h-4" />
        </div>
                ...
                <div class="">
                    @auth
                        @if (auth()->user()->user_role == 0)
                            <a href="{{ route('dashbord.farmer') }}"
                                class="py-2 px-4 text-white bg-black rounded-3xl">Farmer</a>
                        @endif
                        @if (auth()->user()->user_role == 1)
                            <a href="{{ route('dashbord.buyer') }}"
                                class="py-2 px-4 text-white bg-black rounded-3xl">Buyer</a>
                        @endif
                    @else
        ...
        <div id="showMenu" class="md:hidden">
            <img src='{{ url('/') }}/landing/assets/logos/Menu.svg' alt="Menu icon" />
        </div>
    </nav>
    <div id='mobileNav'
        class="hidden px-4 py-6 fixed top-0 left-0 h-full w-full bg-secondary z-20 animate-fade-in-down">
        <div id="hideMenu" class="flex justify-end">
            <img src='{{ url('/') }}/landing/assets/logos/Cross.svg' alt="" class="h-16 w-16" />
        </div>
    ...
    <section
        ...
        <div class="flex justify-around md:block mt-8 md:mt-0 md:flex-1">
            <div class="relative">
                <img src='{{ url('/') }}/landing/assets/Highlight1.svg' alt=""
                    class="absolute -top-16 -left-10" />
            </div>
            <img src='{{ url('/') }}/landing/assets/MacBook Pro.png' alt="Macbook" />
            <div class="relative">
                <img src='{{ url('/') }}/landing/assets/Highlight2.svg' alt=""
    ...
    <!-- How it works -->
    <section class="bg-black text-white sectionSize" id="howitworks">
        <div>
    ...
    <section class="sectionSize bg-secondary" id="features">
        ...
        <div class="md:grid md:grid-cols-2 md:grid-rows-2">
            ...
            <div class="flex items-start font-montserrat my-6 mr-10">
                <img src='{{ url('/') }}/landing/assets/logos/Heart.svg' alt='' class="h-7 mr-4" />
                <div>
    ...
    <section class="sectionSize items-start pt-8 md:pt-36 bg-black text-white" id="faq">
        ...
        <div toggleElement class="w-full py-4">
            <div class="flex justify-between items-center">
                ...
                <img src='{{ url('/') }}/landing/assets/logos/CaretRight.svg' alt=""
    ...
    <section class="bg-black sectionSize">
        <div class="mb-4">
            <img src='{{ url('/') }}/landing/assets/Logo_white.svg' alt="Logo" class="h-4" />
        </div>
        <div class="flex mb-8">
            <a href="#">
                <img src='{{ url('/') }}/landing/assets/logos/Facebook.svg' alt="Facebook logo"
                    class="mx-4" />
            </a>
            <a href="#">
                <img src='{{ url('/') }}/landing/assets/logos/Youtube.svg' alt="Youtube logo" class="mx-4" />
            </a>
            <a href="#">
                <img src='{{ url('/') }}/landing/assets/logos/Instagram.svg' alt="Instagram logo"
                    class="mx-4" />
            </a>
            <a href="#">
                <img src='{{ url('/') }}/landing/assets/logos/Twitter.svg' alt="Twitter logo" class="mx-4" />
            </a>
        </div>
